  ...
  return (
    <section>
      <p className="app-tour">
        ...
        you need to sign up for an account first. As soon as you sign up,
        "Bestie" will email you a verification link.
        <img src={verification} className="demo-image" />
        Click the link and you're all set! Now you can start using the app.
        After you login, you will be redirected to the main page where you can
        ...
        will get their own circle. If you're using a mobile device and you want
        to delete a friend, tap on the circle and click delete. If you’re using
        a laptop, hover over a friend and click delete.
        ...
        For each email update, "Bestie" will email you a verification link to
        make sure we got it right.
        <img src={verification2} className="demo-image" />
        If you ever want to delete your account, click the "delete account"
